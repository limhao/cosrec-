...
def main():
	...
	parser.add_argument('--l2', type=float, default=config.l2)
	...
	parser.add_argument('--drop', type=float, default=config.dropout_p, help='drop out ratio.')
	parser.add_argument('--fc_dim', type=int, default=150)
	parser.add_argument('--ac_fc', type=str, default=config.ac_fun,
